...
using MelonLoader;
using BuildInfo = DebugOutput.BuildInfo;
...
[assembly: MelonInfo(typeof(DebugOutput.Main), BuildInfo.Name, BuildInfo.Version, BuildInfo.Author, BuildInfo.DownloadLink)]
